...
export async function generateMetadata(): Promise<Metadata> {
  const bundles = (await getBundlesWithSessions()).filter((b) => b.is_active);
  ...
  return {
    ...
    description: `Get lifetime access to ${totalSessions} expert-led AI sessions across content creation, development, knowledge systems, and leadership. One payment, no subscription.`,
    openGraph: {
      title: `AI Skill Set Bundles — ${totalSessions} Expert Sessions for $99 | Cozora`,
      description: `Get lifetime access to ${totalSessions} expert-led AI sessions across content creation, development, knowledge systems, and leadership.`,
...
export default async function AIBundlesPage() {
  ...
  const bundleFaqs = [
    ...
    {
      q: 'What if I want the community and weekly skills too?',
      a: 'We offer a Substack membership ($75/month) that includes everything in the bundles plus the creator community of 40+ AI creators and a new Claude skill every week.',
    },
  ];
        ...
        <section className="py-20 sm:py-28 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl text-cz-text-muted mb-10 max-w-2xl mx-auto leading-relaxed">
              {totalBundles} skill set bundles covering content creation, development, knowledge systems, and leadership &mdash; taught by the practitioners building with AI every day.
            </p>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-cz-text-muted max-w-xl mx-auto">
                Each bundle includes video recordings and downloadable guides from expert AI practitioners.
              </p>
            </div>

            <div className="grid md:grid-cols-2 gap-8">
              {bundles.map((bundle) => {
                const colors = skillColorMap[bundle.skill_num as keyof typeof skillColorMap] || {
                  text: 'text-cz-teal',
                  bg: 'bg-cz-teal/10',
